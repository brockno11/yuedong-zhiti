...
**跃动智体**是一个面向中学体育教学场景的 AI 智能信息系统。采用移动端优先的响应式设计，帮助学生记录体测数据、查看体质画像，通过 AI 生成个性化训练计划；教师端支持班级总览、学生画像和 AI 报告审核。
...
### 学生端（移动端优先）
- 🏠 **个人首页** — 高级体质画像入口、综合评分、快捷行动、教师审核提示
- 📝 **引导式信息填写** — 5 步卡片式引导，非传统表单
- 📊 **体测记录向导** — 项目选择→成绩输入→运动体感→恢复情况→完成
- 📈 **体质画像仪表盘** — 响应式 5 维雷达图、趋势折线图、统计卡、本期洞察
- 🤖 **AI 智能指导** — 体质画像、薄弱项分析、2 周训练计划、安全提醒
- 👤 **个人中心** — 基础信息、隐私说明、AI 使用说明

### 教师端
- 📋 **班级总览** — 统计卡片、薄弱项排行、等级分布、重点关注学生
- 👥 **学生画像列表** — 综合评分、优劣势标签、AI 建议状态
- 📄 **AI 班级报告** — 整体分析、共性薄弱项、分层指导、训练重点
